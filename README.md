...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/braceexpand-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7954&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/braceexpand-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `braceexpand` can be installed with:

```
conda install braceexpand
```

It is possible to list all of the versions of `braceexpand` available on your platform with:
